...
colour: 	[
				'Typically red, brown/black or yellow.'
			]
...
uses: 		[
				'Crystals of suitable size and transparency can be fashioned into gemstones.'
			]
extractors: [
				'Sphalerite is produced worldwide, such as the Alston Moor, Germany, Switzerland, Canada and North and South America.'
			]
chabit: 	[
				'Tetrahedral or rhombidodecahedron.'
			]
cstruct: 	'Cubic'
depenv:		[
				'Like Killhope, many deposits form where hydrothermal activity or contact metamorphism has brought hot, acidic, zinc-bearing fluids in contact with carbonate rocks.'
			]
...
gravity: 	'3.9 - 4.1'
properties: [
				'Pure sphalerite transforms to the wurtzite polymorph at 1020°C if oxidation is prevented, but the inversion temperature is lowered by the presence of iron and manganese. Wurtzite can remain stable under 1020°C but any applied stress will convert it into sphalerite.'
			]
