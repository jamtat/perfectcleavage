name:		'Witherite'
formula:	'ZnCO3'
colour: 	'White, colourless, yellow, brown or green'
abundance: 	'Rare'
...
uses: 		'Witherite has been used for hardening steel, and for making cement, glass, enamelware, soap, dye and explosives'
extractors: 'Found in commercial quantities in England, France, Turkmenistan and Japan'
chabit: 	'Striated short prismatic crystals, also botryoidal to spherical'
cstruct: 	'Orthorhombic'
depenv:		'Found in low temperature hydrothermal vein deposits'
tparency: 	'Transparent to translucent'
origin:		'Named in 1790 after the mineralogist William Withering'
observed: 	'Brown, grey/white, white/purple'
usesplus: 	'Up until the 18th century farmers at Anglezarke, Lancashire used the mineral as rat poison'
streak: 	'White'
cleavage: 	'Distinct, imperfect'
fracture: 	'Uneven, brittle'
gravity: 	'4.3'
properties: 'Part of the aragonite group'
