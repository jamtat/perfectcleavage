name:		'Quartz'
formula:	'SiO2'
colour: 	'Most often seen in its colourless or milky white form, although it can also occur in many different coloured varieties'
...
uses: 		'Quartz sand is often used in glass making. Quartz is also used as a gemstone as it is hard, durable, easy to shape and usually accepts a brilliant polish'
extractors: 'United States (Arkansas), India, Brazil and Madagascar'
chabit: 	'Prismatic. Two forms - crystalline and cryptocrystalline (formed of microscopic crystalline particles)'
cstruct: 	'Hexagonal/Trigonal'
depenv:		'Occurs in virtually every mineral environment, often precipitating out of hydrothermal fluid'
...
observed: 	'White, yellow'
usesplus: 	'All forms of quartz are used as gemstones, and they are all affordable. They are cut into various gemstone cuts and cabochons, and used in all forms of jewellry. Lesser quality stones are often tumbled for use in bracelets, necklaces, and as costume jewellry. Large spheres and carvings are also cut from all the quartz forms'
streak: 	'White'
cleavage: 	'None'
fracture: 	'Conchoidal'
gravity: 	'2.7'
