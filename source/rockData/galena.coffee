...
uses: 		'In ancient times lead was widely used for everything from water pipes to cooking pots, however due to our knowledge of its toxic and carcinogenic properties, its applications have been limited. Lead still has many uses in the modern world, from car batteries to the lining of roofs'
extractors: 'Galena is a fairly common mineral and occurs in numerous locations worldwide. Galena is mined in Germany, Kosovo, Romania , and the U.S. tri-state mining district of Kansas, Missouri and Oklahoma'
chabit: 	'Fully grown crystals can be either coarse or fine grained and more rarely fibrous, crystals exceeding 2.5cm are common'
...
depenv:		'In sedimentary limestone deposits, hydrothermal veins, hydrothermal replacement deposits, and in placer deposits. Rarely associated with basalts and diabase'
tparency: 	'Opaque'
...
streak: 	'Lead-grey'
cleavage: 	'Often exhibits a perfect cubic cleavage with abundant triangular pits. This results in it deforming along it’s cube planes'
