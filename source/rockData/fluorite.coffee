name:		'Fluorite'
formula:	'CaF2'
colour: 	'Purple varieties, blue, green, yellow, colourless'
...
extractors: 'China, Mexico, Mongolia, Russia, South Africa, Spain, Namibia'
chabit: 	'Well formed, coarse sized crystals'
cstruct: 	'Cubic'
depenv:		'Vein deposits, often forms a part of the gangue'
...
observed: 	'Brown, purple, violet, blue, green, colourless, grey, amber, white'
usesplus: 	[
...
gravity: 	'3.18'
properties: 'Calcium ions are arranged on a cubic fluorine lattice, a  calcium ion is located at the centre of each cube face and each corner'
relevance: 	'None'
opprop: 	'None'
impurities:	'None'
hero:		'fluorite.jpeg'
