...
uses: 		[
				'Zinc is used for galvanizing steel, producing brass and bronze as well as zinc base alloys.'
			]
extractors: [
				'Significant deposits in Italy, Greece, Namibia, Germany, Mexico, Zambia, US and Australia.'
			]
chabit: 	[
				'Botryoidal or rhombohedral.'
			]
cstruct: 	'Hexagonal or Scalenohedral.'
depenv:		[
				'Smithsonite occurs as a secondary mineral in the weathering or oxidation zone of zinc-bearing ore deposits. It sometimes occurs as replacement bodies in carbonate rocks.'
			]
...
usesplus: 	[
				'Smithsonite is occasionally cut as ornaments and \'en cabochon\' as gems.'
			]
streak: 	'White'
