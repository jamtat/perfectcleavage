name:		'Barytocalcite'
formula:	'BaCa(CO3)'
colour: 	'White, greyish, yellow/brownish'
...
uses: 		'Minor ore of barium'
extractors: 'England, Canada, Russia, USA'
chabit: 	'Prismatic'
cstruct: 	'Monoclinic'
depenv:		'Forms in hydrothermal veins, especially where hydrothermal solutions have invaded limestone'
tparency: 	'Transparent to translucent'
origin:		'Derives its name from its components: barium and calcite'
observed: 	'Brown, yellow/brown, honey, white'
usesplus: 	'None'
streak: 	'White'
cleavage: 	'Perfect, imperfect'
fracture: 	'Uneven, brittle'
gravity: 	'3.7'
properties: 'Soluble in dilute HCl'
