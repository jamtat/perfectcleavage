...
uses: 		'One of two primary iron ores (along side Hematite)'
extractors: 'USA (since ceased), Spain, Brazil, Australia'
chabit: 	'Fine grained aggregate'
cstruct: 	'Amorphous'
depenv:		'Common as a biogenic precipitate in swamps or as microscopic particles staining other minerals in weathered outcrops of metalliferous veins'
tparency: 	'Opaque'
origin:		'Named from the Greek word λειμών, meaning meadow, in allusion to its occurrence as a bog iron ore'
observed: 	'Brown, orange/brown'
usesplus: 	'As a pigment'
